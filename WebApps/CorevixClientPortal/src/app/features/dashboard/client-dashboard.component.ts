    ...
    <div class="space-y-6 animate-fade-in text-foreground relative font-sans">
      ...
      <div class="flex flex-col lg:flex-row justify-between items-stretch lg:items-center gap-4 pb-4 border-b border-border/20">
        ...
        <div class="flex flex-wrap items-center gap-2 text-xs">
          ...
          <button (click)="printStatement()" class="h-10 px-3.5 bg-card hover:bg-slate-200/50 dark:hover:bg-zinc-800 border border-border text-zinc-600 dark:text-zinc-300 font-extrabold rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-sm flex items-center justify-center gap-1.5">
          ...
          <button (click)="loadDashboard()" class="h-10 w-10 border border-border bg-card hover:bg-slate-200/50 dark:hover:bg-zinc-800 text-zinc-500 hover:text-foreground rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-sm flex items-center justify-center" title="Refresh Dashboard">
      ...
      <div class="p-6 bg-[#025864] rounded-3xl text-white shadow-xl relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div class="flex flex-wrap gap-2 z-10 w-full md:w-auto">
          <button (click)="showOpenAccountModal.set(true)" class="flex-1 md:flex-none h-10 px-4 bg-[#00D47E] hover:bg-[#00e88a] text-[#025864] text-xs font-extrabold rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-sm hover:shadow-md hover:shadow-[#00D47E]/10 flex items-center justify-center gap-1.5">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/></svg>
            Add
          </button>
          <button (click)="showGcashModal.set(true)" class="flex-1 md:flex-none h-10 px-4 bg-white/10 hover:bg-white/15 border border-white/10 hover:border-white/20 text-white text-xs font-extrabold rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-1.5">
          ...
          <button (click)="showOpenAccountModal.set(true)" class="h-10 w-10 bg-white/10 hover:bg-white/15 border border-white/10 hover:border-white/20 rounded-xl text-white transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center" title="Options">
          ...
          <div class="p-5 bg-card border border-border rounded-3xl space-y-4">
            <div class="flex justify-between items-center">
              ...
              <div class="flex gap-2">
                <button (click)="printStatement()" class="h-9 px-3.5 border border-border text-[10px] font-bold rounded-lg text-zinc-500 hover:text-foreground hover:bg-slate-50 dark:hover:bg-zinc-800 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] shadow-sm flex items-center gap-1">
        ...
        <div class="xl:col-span-4 space-y-6">
          ...
          <div class="p-5 bg-card border border-border rounded-3xl space-y-4">
            ...
            <div class="space-y-3 pt-2 text-xs">
              ...
              <button (click)="updateCardLimits()" class="w-full h-10 bg-[#025864] dark:bg-[#00D47E] hover:bg-[#013f47] dark:hover:bg-[#00e88a] text-white dark:text-[#025864] text-[10px] font-extrabold rounded-xl transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] shadow-sm flex items-center justify-center gap-1">
            ...
            <div class="space-y-3 text-xs">
              <div>
                ...
                <div class="flex gap-2">
                  ...
                  <button (click)="simulateDeposit()" class="h-10 px-4 bg-[#00D47E]/10 hover:bg-[#00D47E]/20 text-[#00D47E] border border-[#00D47E]/20 font-bold rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] flex items-center gap-1">
              ...
              <div>
                ...
                <div class="flex gap-2">
                  ...
                  <button (click)="simulateWithdrawal()" class="h-10 px-4 bg-red-500/10 hover:bg-red-500/20 text-red-500 border border-red-500/20 font-bold rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] flex items-center gap-1">
        ...
        <div class="fixed inset-0 bg-slate-900/40 dark:bg-zinc-950/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div class="p-5 bg-card border border-border rounded-3xl max-w-sm w-full space-y-4 shadow-2xl">
            ...
            <div class="flex justify-end gap-2 pt-2 text-xs">
              <button (click)="showOpenAccountModal.set(false)" class="h-10 px-4 border border-border rounded-xl text-zinc-500 hover:text-foreground hover:bg-slate-50 dark:hover:bg-zinc-800 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]">Cancel</button>
              <button (click)="openNewAccount()" class="h-10 px-4 bg-[#025864] dark:bg-[#00D47E] hover:bg-[#013f47] dark:hover:bg-[#00e88a] text-white dark:text-[#025864] font-extrabold rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]">Confirm</button>
            </div>
          </div>
        </div>
      }
      ...
      @if (showGcashModal()) {
        <div class="fixed inset-0 bg-slate-900/40 dark:bg-zinc-950/80 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div class="p-5 bg-card border border-border rounded-3xl max-w-sm w-full space-y-4 shadow-2xl">
            ...
            <div class="flex justify-end gap-2 pt-2 text-xs">
              <button (click)="showGcashModal.set(false)" class="h-10 px-4 border border-border rounded-xl text-zinc-500 hover:text-foreground hover:bg-slate-50 dark:hover:bg-zinc-800 transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]">Cancel</button>
              <button (click)="executeGcashCashIn()" class="h-10 px-4 bg-[#00D47E] hover:bg-[#00e88a] text-[#025864] font-extrabold rounded-xl transition-all duration-200 hover:scale-[1.02] active:scale-[0.98]">Top-Up</button>
            </div>
          </div>
        </div>
      }
