  ...
  template: `
    <div class="glass-card p-8 rounded-2xl max-w-md w-full mx-auto shadow-xl transition-all duration-300">
      <div class="text-center mb-6">
        <h2 class="text-3xl font-extrabold tracking-tight text-primary">Corevix Client</h2>
        <p class="text-sm opacity-70 mt-2">Sign in to access your digital vault and accounts</p>
      </div>
